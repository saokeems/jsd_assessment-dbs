...
WHERE
  suppliers.name = 'Freshest Farm Produce'
  ...
  --
  -- Your thinking:
  -- โจทย์ต้องการให้แสดงวัตถุดิบที่ได้รับมาจาก 'Freshest Farm Produce'
  -- เข้าไปดูตาราง ingredients และ suppliers ก่อนเพื่อเช็คขื่อ column ต่างๆ
  -- โจทย์อยากให้แสดงเป็นชื่อวัตถุดิบ เลยเลือกแสดงเฉพาะ ingredients.name ออกมา
  -- จากนั้นก็จะทำการ join เข้ากับตาราง suppliers เพื่อให้ข้อมูลอิงกันตามตัว column supplier_id
  -- แล้วก็ทำการแสดงข้อมูลที่อิงจาก suppliers.name = 'Freshest Farm Produce'